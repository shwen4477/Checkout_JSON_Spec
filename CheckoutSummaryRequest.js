{
	"areaId" : int,					//Идентификатор населенного пункта
	"items" : 						//Товары
      [
	      {
    ...
    "option" : ( "cheap" | "fast"), //Опциональный параметр предвыбора способа доставки (cheap - самый дешевый, fast - самый быстрый)
	  "payment"
		    {
			    "usePoints": decimal,    //Количество использованных баллов для оплаты заказа
			    "useAccount" : decimal   //Количество использованных средств с ПС для оплаты заказа
		    }
}
